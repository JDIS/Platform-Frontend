...
const NavbarLayout = React.createClass({
  ...
  renderAuthenticatedLinks() {
    ...
    return [
      (<NavItemLink key="leaderboard" to="leaderboard"><Glyphicon glyph="stats"/> Classement</NavItemLink>),
      (<NavItemLink key="challenges" to="challenges"><Glyphicon glyph="tasks"/> Liste des défis</NavItemLink>),
